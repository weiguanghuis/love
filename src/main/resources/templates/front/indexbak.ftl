...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="static/front/plug/css/style.css"/>
...
<!-- jQuery Plugins -->
<script src="static/front/plug/js/jquery.min.js"></script>
<script src="static/front/plug/js/bootstrap.min.js"></script>
